...
The `mcp-server.exe` from [coff33ninja/go-mcp-computer-use](https://github.com/coff33ninja/go-mcp-computer-use) exposes **156 tools** that mirror every human peripheral capability on Windows:
