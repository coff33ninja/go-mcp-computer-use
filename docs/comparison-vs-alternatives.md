...
|---------|------|-----|---------|---------|---------|--------|-------|-------|-------------|
| **[go-mcp-computer-use](https://github.com/coff33ninja/go-mcp-computer-use)** | Go | ✅ | ✅ Win | ✅ YOLO11+MobileNet + Go-native transformer | ✅ auto-collect + self-improving | ✅ SQLite FTS | 161 | — | ✅ MIT |
...
|---------|-------------------|------------|
| **Interface** | MCP protocol (161 tools) | CLI commands |
...
| **Language** | Go | Rust |
| **Unique** | Training pipeline, memory, priors, Go-native transformer (self-improving), 161 tools | `screen tokenize` for structured UI tokens |

**Verdict**: DesktopCtl prioritizes privacy (screenshots not shared by default) and structured token output. go-mcp-computer-use prioritizes depth (training, memory, 161 tools).
