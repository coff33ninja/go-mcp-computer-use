...
| `gen-tools-doc.go` | `go run ./scripts/gen-tools-doc.go` | AST-based extraction of all 146 MCP tool definitions, generates `docs/reference/tools.md` sorted by category |
