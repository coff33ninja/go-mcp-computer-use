...
| `gen-wiki.go` | `go run ./scripts/gen-wiki.go` | Compiles all project docs into 13 wiki pages in `wiki/` — synced to [GitHub Wiki](https://github.com/coff33ninja/go-mcp-computer-use/wiki) via `publish-wiki.yml` workflow |
